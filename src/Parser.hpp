...
class Parser{
    ...
    private:
        ...
        map<pair<Component::Component::Component::component_type,int>, double> weights = {
            {make_pair(Component::Component::REG,1),2.616},{make_pair(Component::Component::REG,2),2.644},{make_pair(Component::Component::REG,8),2.879},{make_pair(Component::Component::REG,16),3.061},{make_pair(Component::Component::REG,32),3.602},{make_pair(Component::Component::REG,64),3.696},
            {make_pair(Component::Component::ADD,1),2.704},{make_pair(Component::Component::ADD,2),3.713},{make_pair(Component::Component::ADD,8),4.824},{make_pair(Component::Component::ADD,16),5.638},{make_pair(Component::Component::ADD,32),7.270},{make_pair(Component::Component::ADD,64),9.566},
            {make_pair(Component::Component::SUB,1),3.024},{make_pair(Component::Component::SUB,2),3.412},{make_pair(Component::Component::SUB,8),4.890},{make_pair(Component::Component::SUB,16),5.569},{make_pair(Component::Component::SUB,32),7.253},{make_pair(Component::Component::SUB,64),9.566},
            {make_pair(Component::Component::MUL,1),2.438},{make_pair(Component::Component::MUL,2),3.651},{make_pair(Component::Component::MUL,8),7.453},{make_pair(Component::Component::MUL,16),7.811},{make_pair(Component::Component::MUL,32),12.395},{make_pair(Component::Component::MUL,64),15.354},
